...
export class AIService {
    ...
    async generateSQL(request: QueryGenerationRequest): Promise<QueryGenerationResponse> {
        ...
        try {
            ...
            throw new Error(`${i18n.t('messages.error.generation')} - ${i18n.t('messages.error.unknown')}`);
        }
    }
                                ...
                                try {
                                    ...
                                    if (data.type === 'content_block_delta') {
                                        ...
                                        if (inSqlBlock && cleanedText.length > 0) {
                                            ...
                                            vscode.commands.executeCommand('sqlwizard.appendToStreamingEditor', cleanedText);
                                        }
